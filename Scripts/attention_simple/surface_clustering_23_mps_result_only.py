...
from torch.utils.data import DataLoader  # noqa: F401 – kept for WindowedDataset compatibility
...
def setup_logging(log_dir: Path = Path(".")) -> logging.Logger:
    ...
    log_path = log_dir / f"run_{RUN_TS}_23_gpu.log"
...
CONFIG = {
    ...
    # Output directories (figures_dir is overridden per-run in main())
...
def main():
    ...
    logger.info("\n[7] t-SNE + UMAP visualisation (test split) — saving plots")
    ...
    logger.info("\n[8] VibClustNet diagnostic plots")
