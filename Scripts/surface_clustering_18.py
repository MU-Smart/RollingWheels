...
#   (5)       → class 3  : Asphalt                 (unique)
#   (6, 7, 8) → class 4  : Indoor — Carpet/Lino/Tile
#   (9, 10)   → class 5  : Curb Up + Down
#   (12)      → class 6  : Paving Blocks Rough      (unique)
MERGE_MAP = {
